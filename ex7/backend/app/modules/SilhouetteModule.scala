...
import com.mohiva.play.silhouette.impl.providers.oauth2.{GitHubProvider, GitLabProvider, GoogleProvider}
...
import services.{OAuth2InfoRepository, PasswordInfoRepository, UserRepository}
...
class SilhouetteModule extends AbstractModule with ScalaModule {
  ...
  @Provides
  def provideSocialProviderRegistry(googleProvider: GoogleProvider, gitHubProvider: GitHubProvider, gitLabProvider: GitLabProvider): SocialProviderRegistry =
    SocialProviderRegistry(Seq(googleProvider, gitHubProvider, gitLabProvider))
